...
with open(os.path.join(path, "shaders/vert.spv"), 'rb') as f:
    vert_shader_spirv = f.read()
with open(os.path.join(path, "shaders/frag.spv"), 'rb') as f:
...
empty_input_state = VkPipelineVertexInputStateCreateInfo(
